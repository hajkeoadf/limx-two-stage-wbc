...
class Cfg(PrefixProto, cli=False):
    ...
    class domain_rand(PrefixProto, cli=False):
        ...
        friction_range = [0.0, 1.6]  # increase range
    ...
    class rewards(PrefixProto, cli=False):
        ...
        gait_force_sigma = 25.
        gait_vel_sigma = 0.25
        gait_height_sigma = 0.05  # Added: used by _reward_tracking_contacts_shaped_height
